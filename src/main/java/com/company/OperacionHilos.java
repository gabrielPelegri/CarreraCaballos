...
class OperacionHilos extends Thread {
    ...
    public void run(){
        ...
        OperacionesHilos[] corredor = new OperacionesHilos[numCorredores];
        for (int i = 0; i < numCorredores; i++) {
            corredor[i] = new OperacionesHilos( i+1, res, numCarrera); //A cada hilo le paso su contador, el almacén y el número de carrera en el que se encuentra
